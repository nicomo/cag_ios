...
- (void)viewDidLoad
{
    ...
    histotitle.scrollEnabled = NO;
    histotitle.userInteractionEnabled = NO;
    ...
    historique.scrollEnabled = NO;
    historique.userInteractionEnabled = NO;
    ...
    convtitle.scrollEnabled = NO;
    convtitle.userInteractionEnabled = NO;
    ...
    savoirtitle.scrollEnabled = NO;
    savoirtitle.userInteractionEnabled = NO;
    ...
    savoir.scrollEnabled = NO;
    savoir.userInteractionEnabled = NO;
    ...
    eventstitle.scrollEnabled = NO;
    eventstitle.userInteractionEnabled = NO;
    ...
    events.scrollEnabled = NO;
    events.userInteractionEnabled = NO;
